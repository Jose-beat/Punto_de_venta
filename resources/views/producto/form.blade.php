...
<!---Adapted --->
     <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input step="any" type="number" id="precio_venta" name="precio_venta" class="form-control" placeholder="Ingrese el precio venta" required pattern="^[a-zA-Z_áéíóúñ\s]{0,100}$">
                </div>
    </div>
