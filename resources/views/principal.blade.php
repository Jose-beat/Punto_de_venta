...
<head>
    ...
    <title>Agrovet "Las Palmas"</title>
    <!-- Icons -->
    <link href="{{asset('css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('css/simple-line-icons.min.css')}}" rel="stylesheet">
    <link rel="shortcut icon" href="{{asset('storage/src/Logo.png')}}" />
...
<header class="app-header navbar   ">
        ...
        <ul class="nav navbar-nav d-md-down-none">
            <li class="nav-item px-3">
                <a class="text-dark" href="#">Agro-vet</a>
            </li>
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle nav-link text-darks" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
    ...
    <footer class="app-footer">
        <span><a href="http://www.dropserver.com/">dropserver.com</a> &copy; 2020</span>
        <span class="ml-auto">Desarrollado por <a href="http://www.dropserver.com/">dropserver.com</a></span>
    </footer>
