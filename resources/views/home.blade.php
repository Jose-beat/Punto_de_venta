...
<main class="main">
            ...
            <ol class="breadcrumb bg-success" >
                <li class="breadcrumb-item active"><a href="/" class="text-light">BACKEND - SISTEMA DE COMPRAS - VENTAS</a></li>
            </ol>
                ...
                <div class="row">
                            ...
                            <div class="card text-white bg-danger rounded">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value h2"><strong>MXN {{$total->totalcompra}} </strong></div>
                                    <div class="h2">Compra de Hoy</div>
                                </div>
                            ...
                            <div class="card text-white bg-success rounded">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="text-value h2"><strong>MXN {{$total->totalventa}}  </strong></div>
                                    <div class="h2">Venta de Hoy</div>
                                </div>
                                <div class="chart-wrapper mt-3 mx-3" style="height:35px;">
                ...
                @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-6 rounded">
                                ...
                                <div class="card card-chart rounded">
