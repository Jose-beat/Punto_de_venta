...
<div class="sidebar">
            <nav class="sidebar-nav ">
                <ul class="nav ">
                    <li class="nav-item ">
                    <a class="nav-link" href="{{url('home')}}" onclick="event.preventDefault(); document.getElementById('home-form').submit();"><i class="fa fa-folder"></i> Dashboard</a>


                            <form id="home-form" action="{{url('home')}}" method="GET" style="display: none;">
                            {{csrf_field()}}
                            </form>
                            <form id="semanal-form" action="{{url('semanal')}}" method="GET" style="display: none;">
                            {{csrf_field()}}
                            </form>

                    </li>
                    <li class="nav-title  text-light">
                        Menú
                    </li>
                    ...
                    <li class="nav-item">
                           ...
                           <a class="nav-link" href="{{url('categoria')}}" onclick="event.preventDefault(); document.getElementById('categoria-form').submit();"><i class="fa fa-cubes"></i> Categorías</a>
...
<!---Seccion de creditos--->
                    <li class="nav-item ">
                        <a class="nav-link" href="{{url('credito')}}" onclick="event.preventDefault(); document.getElementById('credito-form').submit();"><i class="fa fa-credit-card"></i> Creditos</a>
                        <form id="credito-form" action="{{url('credito')}}" method="GET" style="display: none;">
                            {{csrf_field()}}
                         </form>
                    </li>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="{{url('rol')}}" onclick="event.preventDefault(); document.getElementById('rol-form').submit();"><i class="fa fa-id-card"></i> Roles</a>
            ...
            <button id="mini"  class="sidebar-minimizer brand-minimizer-light"type="button"></button>
        </div>
