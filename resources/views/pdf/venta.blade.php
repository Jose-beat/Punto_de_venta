...
<html>
    ...
    <body>
        <h2>Agrovet "Las Palmas"  <span class="derecha">Logito</span></h2>
        <div>
            <h3>Fecha de generacion del documento <span class="derecha"> {{now()}}</span></h3>
        </div>
        <div>
        ...
        <footer>
            ...
            <div id="datos">
                <p id="encabezado">
                    <b>Agrovet "Las Palmas"</b><br>NombreVendedor<br>Telefono:(+00)123456799<br>Email:Email@gmail.com
                </p>
            </div>
        </footer>
    </body>
