    ...
    {{csrf_field()}}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                        ...
                        <input required type="text" id="num_venta" name="num_venta" class="form-control" placeholder="Ingrese el número venta" pattern="[0-9]{0,15}">
                </div>
            </div>
            ...
            <div class="form-group row border">
                 ...
                 <div class="col-md-8">
                        ...
                        <label class="form-control-label" for="nombre">Producto</label>
                            ...
                            <option id="product_selected" value="{{$prod->id}}_{{$prod->precio_venta}}_{{$prod->stock}}">{{$prod->producto}}</option>

                            @endforeach

                            </select><!--- <option value="0" type="number" disabled id="stock" name="stock" class="form-control" placeholder="Ingrese el stock" pattern="[0-9]{0,15}"></label>--->
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                        <label class="form-control-label" for="stock">Cantidad en stock actual</label>



                        <input value="0" type="number" disabled id="stock" name="stock" class="form-control"  pattern="[0-9]{0,15}">


                </div>

                <div class="col-md-2">
                        <label class="form-control-label" for="stock">Cantidad stock restante</label>



                        <input value="0" type="number" disabled id="stocki" name="stock" class="form-control"  pattern="[0-9]{0,15}">
                ...
                <div class="col-md-2">
                        ...
                        <input value="0" type="number" disabled id="precio_venta" name="precio_venta" class="form-control"   >
                </div>
