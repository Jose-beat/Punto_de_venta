...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['Administrador']], function () {
      ...
      Route::get('/listarVentaPdf', 'VentaController@listarMesesPdf')->name('ventas_Meses_pdf');
      Route::get('/listarCreditoPdf', 'CreditoController@listarMesesPdf')->name('creditos_Meses_pdf');
